# Solution
The getDirectors method of Main Class calls to a Service to execute the Http get method defined into DirectaMoviesClient.
Jackson-databind dependency was implemented to mapping the response to dto class.
After getting the list of directors it was filtered counting the frequency and sorted to return the result. 
